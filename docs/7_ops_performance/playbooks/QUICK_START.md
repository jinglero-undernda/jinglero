...
1. **Open the relevant playbook** (e.g., `PLAYBOOK_01_DOCUMENT_TARGETS.md`)
...
```
[You paste PLAYBOOK_01_DOCUMENT_TARGETS.md]
...
1. Use **PLAYBOOK_01_DOCUMENT_TARGETS.md**
...
1. Use **PLAYBOOK_02_VALIDATE_METRICS.md**
