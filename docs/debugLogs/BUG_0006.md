...
- Verify that existing incorrectly-created relationships are handled (may need data migration)
- Test from both Jingle page (selecting Cancion) and Cancion page (selecting Jingle)
- Ensure the fix doesn't break other relationship types
